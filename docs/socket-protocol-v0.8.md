# 《海战 OCEAN》Socket.IO 协议 v0.8

> 实现版本：postlaunch-v0.6.2  
> 协议版本：1.5  
> 规则依据：rule-v1.4.md、page-flow-v1.4.md  
> 变更重点：三人同回合多目标操作、全局直升机、多目标终局鱼雷与独立敌方地图。
...
前端发布信息应与 `postlaunch-v0.6.2 / rule-v1.4 / Socket 1.5` 一致。
...
协议 1.5 不增加新玩法入口；它只是把 `rule-v1.4` 的三人双目标回合明确映射到 Socket 安全状态与行动记录。
