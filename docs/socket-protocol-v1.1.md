# 《海战 OCEAN》Socket.IO 协议 v1.1

> 实现版本：Ocean-v1.2.1  
> 协议版本：1.8  
> 规则依据：rule-v1.6.md、page-flow-v1.8.md  
> 变更重点：创建房间增加地图档位，并在安全状态中下发服务器派生的完整地图规则。
...
前端发布信息应与 `Ocean-v1.2.1 / rule-v1.6 / Socket 1.8` 一致。
...
- 协议 1.8 客户端必须先按 `mapSize` 配置坐标与舰队，再渲染部署或战斗状态。
