...
const REQUIRED_PATHS = Object.freeze([
  ...
  "docs/release-manifest-Ocean-v1.5.1.md",
  "docs/release-manifest-Ocean-v1.5.2.md",
  "docs/release-manifest-Ocean-v1.5.3.md",
  "docs/release-manifest-Ocean-v1.5.4.md",
  "docs/release-manifest-Ocean-v1.5.5.md",
  "docs/release-manifest-Ocean-v1.5.7.md",
  "docs/release-manifest-Ocean-v1.5.8.md",
  "docs/release-manifest-Ocean-v1.5.9.md",
  "docs/release-manifest-Ocean-v1.6.0.md",
  "docs/acceptance-v1.6.0.txt",
  "docs/release-manifest-Ocean-v1.6.1.md",
  "docs/acceptance-v1.6.1.txt",
  "docs/rule-v1.8.md",
  ...
  "test/ocean-v1.4.2-theme-map.test.js",
  "test/ocean-v1.4.2.1-ui-fixes.test.js",
  "test/ocean-v1.4.2.2-map-tabs.test.js",
  "test/ocean-v1.5-command-bridge.test.js",
  "test/ocean-v1.5.1-layout-fix.test.js",
  "test/ocean-v1.5.2-art-assets.test.js",
  "test/ocean-v1.5.3-full-console.test.js",
  "test/ocean-v1.5.4-feedback-assets.test.js",
  "test/ocean-v1.5.5-interaction-polish.test.js",
  "test/ocean-v1.5.7-battle-effects.test.js",
  "test/ocean-v1.5.8-three-player-ui.test.js",
  "test/ocean-v1.5.9-responsive-layout.test.js",
  "test/ocean-v1.6.0-cross-device.test.js",
  "test/ocean-v1.6.1-tactical-layers.test.js",
  "public/css/v1.6.0.css",
  "public/css/v1.6.1.css",
  "public/assets/images/ocean-2.5d/source-asset-manifest.json",
  "public/assets/images/ocean-2.5d/ocean/ocean_deep_active.webp",
  "public/assets/images/ocean-2.5d/actions/action_radar_scan.webp",
  "public/assets/images/ocean-2.5d/ui/buttons/btn_confirm_green.webp",
  "public/assets/images/ocean-2.5d/ui/panels/panel_side_status_card.webp",
  "public/assets/images/ocean-2.5d/layers/surface/surface_specular_seamless.webp",
  "public/assets/images/ocean-2.5d/layers/underwater/underwater_depth_haze.webp",
  "public/assets/images/ocean-2.5d/layers/transitions/submerge_surface_wake.webp",
