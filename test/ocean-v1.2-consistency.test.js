...
test("Ocean-v1.2 前后端正式发布元数据使用同一基线", () => {
  assert.equal(pkg.version, "1.2.0");
  assert.equal(RELEASE_VERSION, "1.2.0");
  assert.equal(RELEASE_STAGE, "Ocean-v1.2");
...
test("当前规则与页面流程文档冻结三种地图和 v1.2 交互边界", () => {
  const currentDocs = [
    read("README.md"),
    read("docs/rule-v1.6.md"),
    read("docs/page-flow-v1.7.md"),
    read("docs/socket-protocol-v1.1.md"),
    read("docs/release-manifest-Ocean-v1.2.md"),
  ].join("\n");
...
test("音效、背景音乐入口与可关闭实时播报均打包在正式前端", () => {
