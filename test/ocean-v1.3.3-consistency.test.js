...
test("Ocean-v1.6.1 前后端正式发布元数据使用同一基线", () => {
  assert.equal(pkg.version, "1.6.1");
  assert.equal(RELEASE_VERSION, "1.6.1");
  assert.equal(RELEASE_STAGE, "Ocean-v1.6.1");
...
test("当前文档冻结 v1.4 战术海面、v1.3 教程、人机边界与真实素材音效范围", () => {
  const currentDocs = [
    ...
    read("docs/release-manifest-Ocean-v1.5.md"),
    read("docs/release-manifest-Ocean-v1.5.1.md"),
    read("docs/release-manifest-Ocean-v1.5.4.md"),
    read("docs/release-manifest-Ocean-v1.5.5.md"),
    read("docs/release-manifest-Ocean-v1.5.7.md"),
    read("docs/release-manifest-Ocean-v1.5.8.md"),
    read("docs/release-manifest-Ocean-v1.5.9.md"),
    read("docs/release-manifest-Ocean-v1.6.0.md"),
    read("docs/release-manifest-Ocean-v1.6.1.md"),
  ].join("\n");
